...
export function remove(model, _primarycontactnumber, response) {
...
export function update(model, requestBody, response) {
...
export function create(model: mongoose.Model<any>, requestBody, response) {
	var contact = toContact(requestBody, model);
	var primarynumber = requestBody.primarycontactnumber;
	contact.save(function (error) {
		if (!error) {
...
export function findByNumber(model, _primarycontactnumber, response) {
...
export function list(model, response) {
...
export function query_by_arg(model, key, value, response) {
...
export function updateImage(gfs, request, response) {
...
export function getImage(gfs, _primarycontactnumber, response) {
...
export function deleteImage(gfs, mongodb, _primarycontactnumber, response) {
